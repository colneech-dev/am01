...
module odocrypt_gpio_wrapper #(
    ...
    parameter [31:0] ODO_SEED = 32'd1789344000
) (
    // ---------------------------------------------------------------
...
`endif
    ...
    found_path #(
        ...
        // Cycles between successive results from ONE core. found_path's stash
        // is NUM_MINERS-1 deep and drains one per cycle, so it keeps every
        // simultaneous find if and only if NUM_MINERS <= THROUGHPUT -- and it
        // now refuses to elaborate otherwise. The cipher core is generated by
        // `odo_gen <seed> 4 encrypt_4`, hence 4; change both together.
        .THROUGHPUT   (4),
