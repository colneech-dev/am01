...
//
// Derived from ../am01_qmtech_top.v for the 4-instance shared-BRAM experiment.
...
module am01_qmtech_top_mux1 (
    ...
    // -----------------------------------------------------------------
    odocrypt_gpio_wrapper_mux4 #(.NUM_MINERS(1)) odocrypt_gpio_wrapper_inst (
        .bus_clk   (bus_clk),
        .clk_2x    (clk_2x),
        .bus_rst_n (bus_rst_n),
