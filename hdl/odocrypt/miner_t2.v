...
`timescale 1ns / 1ps
//
// THROUGHPUT=2 variant of miner.v, for the "wide single miner" hashrate
// option (RESULTS.md "Option A: THROUGHPUT=2 + LUTRAM conversion"). Doubles
// the parallel round logic (unrolling 21 -> 42) against a matching
// `encrypt_2encrypt` core generated by
// `odo_gen <epoch> 2 encrypt_2 --bram-out-reg --lutram=N`.
//
...
`define  THROUGHPUT 2 // CHANGED: was 4
...
module odo_keccak(clk, in, read, target, out, write);
	...
	encrypt_2encrypt crypt(clk, in, read, midstate, midread); // CHANGED: was encrypt_4encrypt
